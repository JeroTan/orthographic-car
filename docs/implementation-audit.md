...
| Terrain and cornering speed | Porsche asset is calibrated against 4.469 m length and 1.852 m width. One world unit is 0.9104 m; 20 km/h moves 6.102 world units/s (1.24 car lengths/s). Road travel tops out at 100.383 world units/s (329 displayed km/h); meadow travel accelerates more slowly and tops out at 54.036 (177 displayed km/h). Reverse is capped at 46.317 on roads and 27.155 on meadow. Forward acceleration tapers with speed to model gearing and aerodynamic load. Leaving road preserves momentum while meadow resistance reduces excess speed. Speed-proportional cornering drag slows sustained turns. | Vehicle tests compare calibrated dimensions, 20 km/h travel scale, road/meadow forward acceleration, Porsche-scale 0–100 timing, forward/reverse top speeds, smooth road-to-meadow transition, and turning versus equivalent straight travel. |
...
- Vitest: 6 files, 42 tests, all passing.
