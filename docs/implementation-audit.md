...
| Terrain and cornering speed | Road travel tops out at 26 world units/s (329 displayed km/h); meadow travel accelerates more slowly and tops out at 14 (177 displayed km/h). Reverse is capped at 12 on roads and 7 on meadow. Forward acceleration tapers with speed to model gearing and aerodynamic load. Leaving road preserves momentum while meadow resistance reduces excess speed. Speed-proportional cornering drag slows sustained turns. | Vehicle tests compare road/meadow forward acceleration, Porsche-scale 0–100 timing, forward/reverse top speeds, smooth road-to-meadow transition, and turning versus equivalent straight travel. |
